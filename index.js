...
console.log(squareEveryDigit(946)) //  test to see if the function squareEveryDigit is working. When running 946, you should see a result of 811636
...
// ANSWER: No. the for-loop is usually O(n), the code used inside this for-loop prevents it from going past 4 iterations.
...
function squareEveryDigit(number) {
  ...
  //the function returns the numbers in the squared array after joining them together.
  return squaredArr.join('');
}
squareEveryDigit(946)// When running 946, you should see a result of 811636 (I console.log the result at the top of the file)
